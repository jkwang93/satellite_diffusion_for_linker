...
def setup_shared_args(parser):
    """
    Sets up the argparse object for the zinc dataset
    ...
    parser.add_argument('--target', type=str, default='',
                        help='Learning target for a dataset (such as zinc) with multiple options.')
...
def init_argparse(dataset):
    ...
    ----------
    dataset : :class:`str`
        Dataset being used.  Currently 'md17' and 'zinc' are supported.
