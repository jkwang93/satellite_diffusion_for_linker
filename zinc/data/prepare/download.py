...
from zinc.data.prepare.md17 import download_dataset_md17
from zinc.data.prepare.qm9 import download_dataset_qm9
...
def prepare_dataset(datadir, dataset, subset=None, splits=None, cleanup=True, force_download=False):
    ...
    dataset : str
        String specification of the dataset.  If it is not already downloaded, must currently by "zinc" or "md17".
    subset : str, optional
    ...
    if new_download or force_download:
        ...
        if dataset.lower().startswith('zinc'):
            ...
            raise ValueError(
                'Incorrect choice of dataset! Must chose zinc/md17!')
