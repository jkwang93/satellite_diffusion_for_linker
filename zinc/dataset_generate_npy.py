...
from zinc.data.args import init_argparse
from zinc.data.collate import PreprocessQM9_npy
from zinc.data.utils import initialize_datasets


def retrieve_dataloaders(cfg):
    if 'zinc' in cfg.dataset:
        batch_size = cfg.batch_size
        num_workers = cfg.num_workers
        filter_n_atoms = cfg.filter_n_atoms
        # Initialize dataloader
        args = init_argparse('zinc')
        ...
        preprocess = PreprocessQM9_npy(load_charges=cfg.include_charges)
