...
from zinc.raw_code.data.dataset_class import ProcessedDataset
from zinc.raw_code.data.prepare import prepare_dataset
...
def initialize_datasets(args, datadir, dataset, subset=None, splits=None,
    ...
    datafiles = prepare_dataset(
        datadir, 'zinc', subset, splits, force_download=force_download)
