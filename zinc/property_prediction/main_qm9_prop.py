...
from zinc.property_prediction.models_property import EGNN, Naive, NumNodes
import torch
from torch import nn, optim
import argparse
from zinc.property_prediction import prop_utils
import json
from zinc import dataset, utils
import pickle
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, default="qm9_first_half", metavar='N',
                        help='qm9_first_half')
    parser.add_argument('--datadir', type=str, default="../../zinc/temp", metavar='N',
                        help='qm9_first_half')
