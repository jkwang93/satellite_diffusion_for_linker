...
from zinc.utils import compute_mean_mad
from zinc.sampling import sample
from zinc.property_prediction.main_qm9_prop import test
from zinc.property_prediction import main_qm9_prop
...
if __name__ == "__main__":
    ...
    parser.add_argument('--classifiers_path', type=str, default='zinc/property_prediction/outputs/exp_class_alpha_pretrained')
