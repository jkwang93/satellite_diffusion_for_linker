...
from zinc.models import get_model
import os
...
from zinc.sampling import sample
from zinc.analyze import analyze_stability_for_molecules, analyze_node_distribution
from zinc.utils import prepare_context, compute_mean_mad
from zinc import visualizer as qm9_visualizer
import zinc.losses as losses

try:
    from zinc import rdkit_functions
except ModuleNotFoundError:
...
def main():
    ...
    parser.add_argument('--model_path', type=str, default="outputs/zinc_linker_resume",
